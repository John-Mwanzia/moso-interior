...
<head>
    ...
    <title>Johns Interior - HTML CSS Template</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light fixed-top shadow-lg">
        <div class="container">
            <a class="navbar-brand" href="index.php">Johny's <span class="tooplate-red">Inter</span><span class="tooplate-green">ior</span></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 text-center mx-auto">
                        <div class="hero-section-text">
                            ...
                            <h1 class="hero-title text-black/40 mt-2 mb-4">Decorate a beautiful interior for your space</h1>

                            <form class="custom-form hero-form" action="includes/contact.php" method="post" role="form">
                                <div class="row">
                        ...
                        <div class="shop-thumb">
                            <div class="shop-image-wrap">
                                ...
                                <div class="shop-btn-wrap">
                                    <a href="shop-detail.php" class="shop-btn custom-btn btn d-flex align-items-center align-items-center">Learn more</a>
                                </div>
                            </div>
        ...
        <section class="contact-section" id="section_5">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <form class="custom-form contact-form" action="includes/contact.php" method="post" role="form">
                            <!-- display success message if it is there -->
                            <?php
                            $message = $_GET['message'] ?? '';

                            if ($message == 'success') {

                                echo '<div class="alert alert-success width:50%" role="alert">
...
<!-- 
                    <div class="row">
                        <div class="col-12 mt-5">
                            ...
                            <a href="includes/generate_report.php?format=csv" class="btn btn-primary">Download CSV</a>
    ...
    <div class="svg-container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#161C2D" fill-opacity="1" d="M0,96L40,117.3C80,139,160,181,240,186.7C320,192,400,160,480,149.3C560,139,640,149,720,176C800,203,880,245,960,250.7C1040,256,1120,224,1200,229.3C1280,235,1360,277,1400,298.7L1440,320L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
        </svg>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-5 col-12 mb-3">
                    <h3><a href="index.php" class="custom-link mb-1">Moso Interior</a></h3>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (message === 'success') {
                // Smooth scroll to the contact section immediately
                document.getElementById('section_5').scrollIntoView({
                    behavior: 'smooth',
                    block: 'start'
                });

                // Clear the URL query parameter without reloading the page
